...
%TODO: we have u_t = v, v = D^3/2 u, different splitting than @ model 1.. Use this in FD matrix?
%TODO: Continue writing. STuff below must be adopted to fit model 2. Mention why final condition is 0; we expect some damped advection equation (can back this up with simulation with t until 10.)
